...
public class ChantierResourceIntTest {
    ...
    private static final EtatChantier DEFAULT_ETAT_CHANTIER = EtatChantier.A_L_ETUDE;
    private static final EtatChantier UPDATED_ETAT_CHANTIER = EtatChantier.EN_COURS;
