...
@Component({
    selector: 'jhi-chantier-par-client',
    templateUrl: './chantier-par-client.component.html',
    styleUrls: [
        'chantier.css'
    ]
})
export class ChantierParClientComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.subscription = this.route.params.subscribe((params) => {
           ...
           this.clientService.find(params['id'])
            ...
            // this.devisService.devisByClientId(params['id'])
    ...
    load(id: number) {
        this.chantierService.findByClient(id)
